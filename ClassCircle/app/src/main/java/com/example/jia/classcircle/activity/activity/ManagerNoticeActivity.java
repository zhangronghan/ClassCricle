...
public class ManagerNoticeActivity extends AppCompatActivity {
    ...
    private ImageView img_file_url;
    ...
    private void onClickEvent() {
        ...
        img_notice.setOnClickListener(new View.OnClickListener() { //实现通知发送
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder=new AlertDialog.Builder(ManagerNoticeActivity.this);
                builder.setMessage("是否发布该通知？");
                builder.setTitle("提示");
    ...
    private void initView() {
        ...
        img_file_url= (ImageView) findViewById(R.id.img_file_url);
