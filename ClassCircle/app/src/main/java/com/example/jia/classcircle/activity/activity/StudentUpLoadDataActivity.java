...
public class StudentUpLoadDataActivity extends AppCompatActivity {//学生上传资料
    ...
    private ImageView img_up_load_data;
    private ImageView img_file_url_select;
    ...
    private void onClickEvent() {
        ...
        img_up_load_data.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder=new AlertDialog.Builder(StudentUpLoadDataActivity.this);
                builder.setMessage("是否上传该作业？");
                builder.setTitle("提示");
    ...
    private void initView() {
        ...
        img_up_load_data= (ImageView) findViewById(R.id.img_up_load_data);
        img_file_url_select= (ImageView) findViewById(R.id.img_file_url_select);
